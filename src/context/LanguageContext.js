...
const translations = {
  en: {
    ...
    service_4_name: 'Tienda',
    service_4_price: '$650',
    service_4_desc: 'For businesses ready to sell online without marketplace fees.',
    service_4_f1: 'Everything in Business',
    service_4_f2: 'Online store up to 100 products',
    service_4_f3: 'Self-managed admin panel',
    service_4_f4: 'Product, price and stock management',
    service_4_f5: 'MercadoPago integration',
    service_4_f6: 'Order management',
    service_4_f7: '15-20 day delivery',
    service_4_badge: 'E-COMMERCE',
    service_4_note: 'Complex variants, multi-vendor and custom integrations are quoted under Premium.',
    ...
    service_3_f1: 'Everything in Tienda',
    service_3_f2: 'Unlimited catalog and variants',
    service_3_f3: 'Booking and appointment system',
    service_3_f4: 'API and external system integrations',
    service_3_f5: 'Advanced dashboards and reporting',
    service_3_f6: 'Performance optimization',
    service_3_f7: '20-30 day delivery',
    ...
    contact_project_option2: 'Starter',
    contact_project_option3: 'Business',
    contact_project_option4: 'Tienda',
    contact_project_option5: 'Premium',
    contact_project_option6: 'Other / General inquiry',
    contact_message: 'Tell us about your project',
    contact_send: 'Send Message',
    contact_sending: 'Sending...',
    contact_success: "Message sent! I'll get back to you within 24 hours.",
    contact_error: 'Message could not be sent. Email me directly at onward.digital.studio@gmail.com',
    contact_validation_required: 'Please fill in all fields',
    contact_validation_email: 'Invalid email',
  ...
  es: {
    ...
    service_4_name: 'Tienda',
    service_4_price: '$1.000.000',
    service_4_desc: 'Para negocios que quieren vender online sin depender de comisiones.',
    service_4_f1: 'Todo lo del Business',
    service_4_f2: 'Tienda online hasta 100 productos',
    service_4_f3: 'Panel de administración autogestionable',
    service_4_f4: 'Carga y edición de productos, precios y stock',
    service_4_f5: 'Integración con MercadoPago',
    service_4_f6: 'Gestión de pedidos',
    service_4_f7: 'Entrega en 15-20 días',
    service_4_badge: 'E-COMMERCE',
    service_4_note: 'Variantes complejas, múltiples vendedores e integraciones a medida se cotizan en el plan Premium.',

    service_3_name: 'Premium',
    service_3_price: '$1.400.000+',
    service_3_desc: 'Soluciones full-stack para negocios que necesitan funcionalidad avanzada.',
    service_3_f1: 'Todo lo de la Tienda',
    service_3_f2: 'Catálogo ilimitado y variantes',
    service_3_f3: 'Sistema de reservas y turnos',
    service_3_f4: 'Integraciones con APIs y sistemas externos',
    service_3_f5: 'Dashboards y reportes avanzados',
    service_3_f6: 'Optimización de rendimiento',
    service_3_f7: 'Entrega en 20-30 días',
    ...
    contact_project_option4: 'Tienda',
    contact_project_option5: 'Premium',
    contact_project_option6: 'Otro / Consulta general',
    contact_message: 'Contanos sobre tu proyecto',
    contact_send: 'Enviar Mensaje',
    contact_sending: 'Enviando...',
    contact_success: '¡Mensaje enviado! Te respondo en menos de 24 horas.',
    contact_error: 'No se pudo enviar el mensaje. Escribime directo a onward.digital.studio@gmail.com',
    contact_validation_required: 'Completá todos los campos',
    contact_validation_email: 'Email inválido',
